...
<head>
	<?php include(ROOT.'/api/evento715/_meta_tags.html.php'); ?>
	...
	<?php /* <script type="text/javascript" src="<?php echo URL;?>/js/menupestanas/menupestanas.js"></script>	 */?>
	
	<link rel="stylesheet" href="<?php echo URL;?>/css/960.css"    type="text/css" media="screen" /> 
	<link rel="stylesheet" href="<?php echo URL;?>/api/evento715/layout.css" type="text/css" media="screen" />
