<div id="content_gallery3">
    <table>
        <tr>
            <td><a href="javascript:;" id="upload3">Subir Banner</a></td>
            <td>
                <ul id="gallery3">
                        <!-- Cargar Fotos -->
                </ul>
...
*/
    $sql = "select * from {$ajaxupload['tabla']} where {$ajaxupload['campo']}='{$ajaxupload['id']}' and cual='{$ajaxupload['cual']}' and {$ajaxupload['campo']}>0 ";
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        new AjaxUpload(button,{
            action: '<?php echo URL;?>/modules/AjaxUpload/ajax/subir_un_banner.php?datos_ajaxupload=<?php echo $datos_ajaxupload;?>',
            name: 'image',
        ...
        $("#gallery3").load("<?php echo URL;?>/modules/AjaxUpload/ajax/subir_un_banner.php?action=listFotos&datos_ajaxupload=<?php echo $datos_ajaxupload;?>");
...
*/
    ...
    function eliminar_afiche(id){
        ...
        $.get("<?php echo URL;?>/modules/AjaxUpload/ajax/subir_un_banner.php?&datos_ajaxupload=<?php echo $datos_ajaxupload;?>&action=eliminar",{id:id},function(){
