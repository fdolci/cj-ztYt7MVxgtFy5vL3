...
(function($){
	$.fn.jContent = function(options){
		...
		this.init = function(hndl){
			...
			//init
			hndl.div = $(hndl);			
			hndl.slides_div = $(hndl).children("div.slides").css("overflow", "hidden").css("position", "relative").css("width", options.width).css("height", options.height).css("float", "right");	
			hndl.currentSlide = 0;
			hndl.lastDirection = '';
