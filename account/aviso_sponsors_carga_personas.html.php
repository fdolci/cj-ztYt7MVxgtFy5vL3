<form name='archivos' action='<?php echo URL;?>/account/aviso_sponsors.html.php?producto_id=<?php echo $producto_id;?>' method='post' enctype="multipart/form-data" >

<fieldset>
	<label for='titulo' style='display:inline-block;line-height:30px;height:30px;width:100px;'>Nombre:</label>
...
<fieldset>
	<label for='web' style='display:inline-block;line-height:30px;height:30px;width:100px;'>Web:</label>
	<input type='text' name='web' id='web' value='<?php echo $data['web'];?>' style='padding:3px; line-height:30px; height:30px; display:inline-block;width:300px;'/>
</fieldset>
...
<fieldset>
	<label for='archivo' style='line-height:30px;height:30px;display:inline-block;'>Logo:</label>
	...
	<br><small>Tamaño máximo permitido: 2Mb.<i>La imagen se mostrará a un tamaño de 150px de ancho por 150px de alto</i> </small>
