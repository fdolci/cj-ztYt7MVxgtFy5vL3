			...
			<table width='100%' >
				<tr>
					...
					<td width='80' align='center' style="color:#000000; font-weight:bold; font-size:12px;">
						<a href='aviso_sponsors.html.php?accion=eliminar&producto_id=<?php echo $producto_id;?>&id=<?php echo $x['id'];?>'
							title='Eliminar este Item'
							onclick="return confirm('Est&aacute; seguro de eliminar este Item?');">
							<img src='<?php echo ADMIN;?>img/del.gif' border='0' /></a>&nbsp;&nbsp;&nbsp;&nbsp;
<?php /*
						<a href='aviso_auspicios.html.php?accion=estado&producto_id=<?php echo $producto_id;?>&id=<?php echo $x['id'];?>' title='Activar / Desactivar' >
							<?php if ($x['activo']==1){ echo "<img src='".ADMIN."img/activo.gif' border='0' />";
							} else { echo "<img src='".ADMIN."img/inactivo.gif' border='0' />"; }?>
						</a>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<a href='aviso_auspicios.html.php?accion=editar&producto_id=<?php echo $producto_id;?>&id=<?php echo $x['id'];?>' title='Editar este Item'>
  ...
  $(document).ready(function() {
    $("#test-list").sortable({
      ...
      update : function () {
		...
		$("#info").load("<?php echo URL;?>/account/aviso_sponsors.html.php?producto_id=<?php echo $producto_id;?>&"+order);
      }
    });
});
</script>
