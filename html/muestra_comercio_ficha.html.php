...
<table style='width:760px;' class='datos'>
			    <tr>
			        <td style='width:50%;padding-right:10px;'>
			            ...
			            <table style='width:100%;'>
			                ...
			                <tr class='tr1'>
			                    ...
			                    <td><span class='ficha_titulo'>Localidad:</span> <?php echo $Producto['ciudad'].' - '.$Producto['provincia'].' - '.$Producto['pais'];?> </td>
			                </tr>
			            ...
			            <h2 style='width:370px;'>Organizador</h2>
			        ...
			        <td style='width:50%;'>
						...
						<?php if(!empty($FB)){;?>
								...
								<div class="fb-like-box" data-href="<?php echo $Producto['facebook'];?>" 
									data-width="340" data-height="200" data-show-faces="true" data-stream="false" data-header="true" 
			...
			<?php if(!empty($Producto['afiche'])){ ?>
			    <hr style='border-top:1px solid #333;margin-top:10px;padding-top:10px;width:650px;'>
			    <img src='<?php echo $Producto['afiche'];?>' style='width:770px;' >
			<?php } ?>
