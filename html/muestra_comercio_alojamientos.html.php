...
<?php
	$url_api = 'http://www.RosarioAlojamientos.com/api/promo_cj/promo_cj.php?evento_id='.$Producto['id'];
	...
	<?php foreach($result as $familia=>$r){ ?>
		<div class="accordion-group">
			<div class="accordion-heading" >
			  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion<?php echo $contador_familia;?>" 
				href="#collapse<?php echo $contador_familia;?>">
